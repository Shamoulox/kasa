  ...
  return (
    <div>
      ...
      <div className="container_selector">
        <SelectorAbout
          title="Fiabilité"
          text="Les annonces postées sur Kasa antissent une fiabilité totale. Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées par nos équipes."
        ></SelectorAbout>
        <SelectorAbout
          title="Respect"
